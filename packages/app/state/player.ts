...
export const PlayerStore = () => {
  ...
  const [showMiniPlayer, setShowMiniPlayer] = useRecoilState(showMiniPlayerAtom)
  ...
  const [positionMillis, setPositionMillis] = useRecoilState(positionMillisAtom)
  ...
  const [playbackInstance, setPlaybackInstance] =
    useRecoilState(playbackInstanceAtom)
