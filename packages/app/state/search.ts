...
export const SearchStore = () => {
  ...
  const [loadingTopChart, setLoadingTopChart] =
    useRecoilState(loadingTopChartAtom)
  const [hasMoreTopChart, setHasMoreTopChart] =
    useRecoilState(hasMoreTopChartAtom)
  ...
  }, [query, debouncedEntriesSearch, debouncedUsersSearch])
