    ...
    <View className={className}>
      ...
      <Modal visible={modalVisible} transparent={true}>
        <SafeAreaView className="flex-1 flex items-center justify-center bg-blue-field/70">
          <View className="flex items-center justify-between w-full max-w-lg bg-blue-field p-4">
            <Pressable
            ...
            <View className="w-64 flex items-center ">
                ...
                {({ handleSubmit }) => (
                  <View>
                    ...
                    <Text className="text-xs leading-none mt-4">
                      ...
                      send if a memo is required, funds will be lost if you send
                      to a wallet that requires a Memo
                    </Text>
                    <Pressable
