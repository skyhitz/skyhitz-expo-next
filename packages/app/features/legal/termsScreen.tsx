  ...
  return (
    ...
    >
      ...
      <ScrollView className="p-8 flex-1">
        ...
        <Text className="section-title">SECTION 1 - ONLINE STORE TERMS</Text>
        <Text className="paragraph">
        ...
        <Text className="section-title">SECTION 2 - GENERAL CONDITIONS</Text>
        <Text className="paragraph">
        ...
        <Text className="section-title">SECTION 7 - OPTIONAL TOOLS</Text>
        <Text className="paragraph">
        ...
        <Text className="section-title">SECTION 8 - THIRD-PARTY LINKS</Text>
        <Text className="paragraph">
        ...
        <Text className="section-title">SECTION 10 - PERSONAL INFORMATION</Text>
        <Text className="paragraph">
        ...
        <Text className="section-title">SECTION 12 - PROHIBITED USES</Text>
        <Text className="paragraph">
        ...
        <Text className="section-title">SECTION 15 - SEVERABILITY</Text>
        <Text className="paragraph">
        ...
        <Text className="section-title">SECTION 16 - TERMINATION</Text>
        <Text className="paragraph">
        ...
        <Text className="section-title">SECTION 17 - ENTIRE AGREEMENT</Text>
        <Text className="paragraph">
        ...
        <Text className="section-title">SECTION 18 - GOVERNING LAW</Text>
        <Text className="paragraph">
