...
export type UpdateUserMutation = { __typename?: 'Mutation', updateUser: { __typename?: 'User', avatarUrl: string, backgroundUrl?: string | null, displayName?: string | null, email: string, username: string, id: string, publishedAt?: string | null, version?: number | null, jwt?: string | null, description?: string | null, publicKey: string, managed: boolean, twitter?: string | null, instagram?: string | null } };
...
export type AuthenticatedUserQuery = { __typename?: 'Query', authenticatedUser: { __typename?: 'User', avatarUrl: string, backgroundUrl?: string | null, displayName?: string | null, email: string, username: string, id: string, description?: string | null, jwt?: string | null, publicKey: string, managed: boolean, twitter?: string | null, instagram?: string | null, lastPlayedEntry?: { __typename?: 'Entry', imageUrl: string, videoUrl: string, description?: string | null, title: string, id: string, artist: string, code: string, issuer: string } | null } };
...
export const UpdateUserDocument = gql`
    mutation updateUser($avatarUrl: String, $backgroundUrl: String, $displayName: String, $description: String, $username: String, $email: String, $twitter: String, $instagram: String) {
  updateUser(
    avatarUrl: $avatarUrl
